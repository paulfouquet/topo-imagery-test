...
## [5.0.0](https://github.com/paulfouquet/topo-imagery-test/compare/v4.9.0...v5.0.0) (2024-08-29)


### ⚠ BREAKING CHANGES

* add new fields to the Collection TDE-985 ([#765](https://github.com/paulfouquet/topo-imagery-test/issues/765))
* standardise_validate should allow 1 output from multiple inputs TDE-784 ([#557](https://github.com/paulfouquet/topo-imagery-test/issues/557))
* resume standardise validate TDE-710 ([#444](https://github.com/paulfouquet/topo-imagery-test/issues/444))
* stac providers TDE-623 ([#348](https://github.com/paulfouquet/topo-imagery-test/issues/348))

### Features

* accept only hyphen named categories TDE-985 ([#830](https://github.com/paulfouquet/topo-imagery-test/issues/830)) ([26682c8](https://github.com/paulfouquet/topo-imagery-test/commit/26682c83565fa400b61378caedc15b50cbe3aabc))
* add --producer-list to allow multiple producers TDE-781 ([#531](https://github.com/paulfouquet/topo-imagery-test/issues/531)) ([0a28d6f](https://github.com/paulfouquet/topo-imagery-test/commit/0a28d6f6f00deae2841d088f9b6a99bfdb437b14))
* add capture-area.geojson to the STAC Collection TDE-965 ([#758](https://github.com/paulfouquet/topo-imagery-test/issues/758)) ([75df081](https://github.com/paulfouquet/topo-imagery-test/commit/75df081ac23e340cce1479a2e2de76b6c1e40e73))
* add checksum to item links in collections TDE-1138 ([#953](https://github.com/paulfouquet/topo-imagery-test/issues/953)) ([afea8f0](https://github.com/paulfouquet/topo-imagery-test/commit/afea8f0f9722d0980657385e420f040e93085eef))
* Add created/updated properties to collections TDE-1147 ([#981](https://github.com/paulfouquet/topo-imagery-test/issues/981)) ([00f4570](https://github.com/paulfouquet/topo-imagery-test/commit/00f457028ea4512419a1fe40344802cb89541729))
* add dem_lerc  preset TDE-779 ([#522](https://github.com/paulfouquet/topo-imagery-test/issues/522)) ([3e7378d](https://github.com/paulfouquet/topo-imagery-test/commit/3e7378d1506a5884b7151a29f6dd3a7281c3650a))
...
* add multiple STAC licensors TDE-643 ([#355](https://github.com/paulfouquet/topo-imagery-test/issues/355)) ([001b9fc](https://github.com/paulfouquet/topo-imagery-test/commit/001b9fc39264d062b302fe9cb15a89d1668066ca))
* add new fields to the Collection TDE-985 ([#765](https://github.com/paulfouquet/topo-imagery-test/issues/765)) ([78016f6](https://github.com/paulfouquet/topo-imagery-test/commit/78016f6b6e01de1b3132e12ebeaf431da61537c2))
* add option to create footprints ([#959](https://github.com/paulfouquet/topo-imagery-test/issues/959)) ([ea5c98b](https://github.com/paulfouquet/topo-imagery-test/commit/ea5c98baa584c5445dcbedf159d409dfeeddf7ce))
* Add Shapely type library TDE-1205 ([#988](https://github.com/paulfouquet/topo-imagery-test/issues/988)) ([f5e97e7](https://github.com/paulfouquet/topo-imagery-test/commit/f5e97e779c61246aadf99bbb4cf9538ffcb5a981))
...
* convert nodata to alpha TDE-625 ([#342](https://github.com/paulfouquet/topo-imagery-test/issues/342)) ([6710aea](https://github.com/paulfouquet/topo-imagery-test/commit/6710aea24306f5e651480e96215fdb447fe9aab8))
...
* Dependabot for Docker TDE-963 ([#746](https://github.com/paulfouquet/topo-imagery-test/issues/746)) ([250b82c](https://github.com/paulfouquet/topo-imagery-test/commit/250b82c196c1f3db601e9712d6834d6da28e6952))
* deploy containers to ecr TDE-689 ([#408](https://github.com/paulfouquet/topo-imagery-test/issues/408)) ([31c713c](https://github.com/paulfouquet/topo-imagery-test/commit/31c713c9d5b7336f6af408e8a3bd6d592db9f831))
* download files using multithreading TDE-822 ([#580](https://github.com/paulfouquet/topo-imagery-test/issues/580)) ([8ab269d](https://github.com/paulfouquet/topo-imagery-test/commit/8ab269de0a06f735039029e53318552341a487ad))
...
* force LERC overview max Z error threshold to 0.1 (10cm) TDE-873 ([#740](https://github.com/paulfouquet/topo-imagery-test/issues/740)) ([0924c13](https://github.com/paulfouquet/topo-imagery-test/commit/0924c132fd01221cb0467cba2126dbc8ba80b269))
* fs.exists() checks if path exists TDE-710 ([#441](https://github.com/paulfouquet/topo-imagery-test/issues/441)) ([f79bd7a](https://github.com/paulfouquet/topo-imagery-test/commit/f79bd7a8b1ea7ef950479a3638595662f3417ed6))
...
* handle standardising paletted tiffs ([#547](https://github.com/paulfouquet/topo-imagery-test/issues/547)) ([aa6ce05](https://github.com/paulfouquet/topo-imagery-test/commit/aa6ce05a7737f34bbaf5287e47e39e34474a01e7))
...
* lint GitHub Actions workflows TDE-919 ([#720](https://github.com/paulfouquet/topo-imagery-test/issues/720)) ([1d32588](https://github.com/paulfouquet/topo-imagery-test/commit/1d325881607c69022dec6c93e178f85e9e05705e))
* log capture-area generation duration TDE-1080 ([#889](https://github.com/paulfouquet/topo-imagery-test/issues/889)) ([5fd8f65](https://github.com/paulfouquet/topo-imagery-test/commit/5fd8f652aef1ce8c24a93a1a1816a9aa7164d880))
...
* make scale optional ([#372](https://github.com/paulfouquet/topo-imagery-test/issues/372)) ([20218bd](https://github.com/paulfouquet/topo-imagery-test/commit/20218bd3edc1af6113be1a917e6a7080525a5891))
* More types ([#989](https://github.com/paulfouquet/topo-imagery-test/issues/989)) ([3f7cd57](https://github.com/paulfouquet/topo-imagery-test/commit/3f7cd571e837ce3d8a8528f181b181d41549dd14))
...
* Pin actions to hashes ([#729](https://github.com/paulfouquet/topo-imagery-test/issues/729)) ([e2343d5](https://github.com/paulfouquet/topo-imagery-test/commit/e2343d5f1959e71d3634f134cd7d61c1447ab261))
* Pin Docker image TDE-958 ([#744](https://github.com/paulfouquet/topo-imagery-test/issues/744)) ([de8a129](https://github.com/paulfouquet/topo-imagery-test/commit/de8a129d60bb7fc16f7872542ee93bc3ce3c9570))
* provide content type to S3 objects TDE-859 ([#642](https://github.com/paulfouquet/topo-imagery-test/issues/642)) ([bbbd653](https://github.com/paulfouquet/topo-imagery-test/commit/bbbd653de36bd8105ec11a9a01314adad60f8f05))
* Remove empty TIFFs after standardising TDE-964 ([#767](https://github.com/paulfouquet/topo-imagery-test/issues/767)) ([70d79b3](https://github.com/paulfouquet/topo-imagery-test/commit/70d79b3d55678fd0a6fc6145005094eab27962b2))
...
* resume standardise validate TDE-710 ([#444](https://github.com/paulfouquet/topo-imagery-test/issues/444)) ([b4022a5](https://github.com/paulfouquet/topo-imagery-test/commit/b4022a509dc7d92e8d10eb384fa1b3408c45463e))
...
* save a copy of capture-area.geojson as an artifact for Argo Workflows TDE-1045 ([#860](https://github.com/paulfouquet/topo-imagery-test/issues/860)) ([a303c05](https://github.com/paulfouquet/topo-imagery-test/commit/a303c05448445281c8168a0614ea150b891221b9))
* script to convert ascii files TDE-814 ([#595](https://github.com/paulfouquet/topo-imagery-test/issues/595)) ([5875d53](https://github.com/paulfouquet/topo-imagery-test/commit/5875d53c2b68f9d661a42f012deb7bbdb639ffe3))
* Set created/updated item properties TDE-1147 ([#980](https://github.com/paulfouquet/topo-imagery-test/issues/980)) ([37ee07f](https://github.com/paulfouquet/topo-imagery-test/commit/37ee07f413f93ab831e8bec4b656d29d31d78dbc))
* simplify footprint geometry tde-1080 ([#891](https://github.com/paulfouquet/topo-imagery-test/issues/891)) ([a932a17](https://github.com/paulfouquet/topo-imagery-test/commit/a932a17125560d9e7007dec733f378d56799256e))
* stac providers TDE-623 ([#348](https://github.com/paulfouquet/topo-imagery-test/issues/348)) ([9bc71a4](https://github.com/paulfouquet/topo-imagery-test/commit/9bc71a47492b9387acf337f738cad594f0c7586b))
...
* standardise_validate allows passing a json file as input TDE-823 ([#564](https://github.com/paulfouquet/topo-imagery-test/issues/564)) ([ebd3e8e](https://github.com/paulfouquet/topo-imagery-test/commit/ebd3e8e00098d145371d8be240e9a97a7cffe2c1))
* standardise_validate should allow 1 output from multiple inputs TDE-784 ([#557](https://github.com/paulfouquet/topo-imagery-test/issues/557)) ([d0ddbbb](https://github.com/paulfouquet/topo-imagery-test/commit/d0ddbbba3d161f3e9249f45eaadd072d8b3810b8))
* standardising 16bits TIFF TDE-628 ([#333](https://github.com/paulfouquet/topo-imagery-test/issues/333)) ([1a07683](https://github.com/paulfouquet/topo-imagery-test/commit/1a07683ece05da6dbafc46c03ca32f666e0e9627))
...
* take source and target epsg, if not the same transform TDE-699 ([#375](https://github.com/paulfouquet/topo-imagery-test/issues/375)) ([547ec88](https://github.com/paulfouquet/topo-imagery-test/commit/547ec88871236c3df674d08a3f75c37c6c0e14c5))
...
* thumbnails creation TDE-839 ([#616](https://github.com/paulfouquet/topo-imagery-test/issues/616)) ([8e2028f](https://github.com/paulfouquet/topo-imagery-test/commit/8e2028f1ea340b9712ac6d00ed8b56980589def5))
* timestamps when created TDE-1147 ([#956](https://github.com/paulfouquet/topo-imagery-test/issues/956)) ([2828f14](https://github.com/paulfouquet/topo-imagery-test/commit/2828f14bc2bfb1bc03963a31a2c2b64ba24f6f75))
* title and description by arguments TDE-960 ([#757](https://github.com/paulfouquet/topo-imagery-test/issues/757)) ([dd3e282](https://github.com/paulfouquet/topo-imagery-test/commit/dd3e282660cc0e652667adf54fe3e5ad3b0b0bea))
...
* use new pull request template ([#999](https://github.com/paulfouquet/topo-imagery-test/issues/999)) ([9a6a0b2](https://github.com/paulfouquet/topo-imagery-test/commit/9a6a0b2971934a03607876c51feb8435ec985e00))
* Use subtests for multi-assert tests ([#896](https://github.com/paulfouquet/topo-imagery-test/issues/896)) ([eb92bd2](https://github.com/paulfouquet/topo-imagery-test/commit/eb92bd2d550013f41538f2beb69e69abf0e6fd5d))
...
* add draft lifecycle tag TDE-1161 ([#964](https://github.com/paulfouquet/topo-imagery-test/issues/964)) ([64040d8](https://github.com/paulfouquet/topo-imagery-test/commit/64040d8a1a0a74b1a42ffd99d6379f4995573c98))
* add latest to tag ([#416](https://github.com/paulfouquet/topo-imagery-test/issues/416)) ([82645ec](https://github.com/paulfouquet/topo-imagery-test/commit/82645ec3432b7f141a9f3af672b4d1aef2a46e68))
* add permissions ([#414](https://github.com/paulfouquet/topo-imagery-test/issues/414)) ([d05aa10](https://github.com/paulfouquet/topo-imagery-test/commit/d05aa1008eb51b8646f74fee675d56d4cbbfc9e9))
* allow unlimited footprint points and increase buffer size for simplifying capture area json ([#872](https://github.com/paulfouquet/topo-imagery-test/issues/872)) ([c733f1e](https://github.com/paulfouquet/topo-imagery-test/commit/c733f1e5dceb40244c8a35452f8bbd59bdd8f50c))
* always ignore existing overviews TDE-1046 ([#862](https://github.com/paulfouquet/topo-imagery-test/issues/862)) ([900907f](https://github.com/paulfouquet/topo-imagery-test/commit/900907f96066564eac4cc7830616f6ed31ee60d4))
...
* AREA_OR_POINT should be forced to AREA for DEMs TDE-787 ([#537](https://github.com/paulfouquet/topo-imagery-test/issues/537)) ([3b92a21](https://github.com/paulfouquet/topo-imagery-test/commit/3b92a21d070b9aabb77c6bbd27b7a9b646e97897))
...
* be specific about nodata being None ([#363](https://github.com/paulfouquet/topo-imagery-test/issues/363)) ([8fe8211](https://github.com/paulfouquet/topo-imagery-test/commit/8fe82113d3f027e46364ecf33cd0ede5271c70ba))
...
* capture area winding order TDE-1205 ([#1008](https://github.com/paulfouquet/topo-imagery-test/issues/1008)) ([61be096](https://github.com/paulfouquet/topo-imagery-test/commit/61be096bc9af997933ef6bee6cd72d441d350bc7))
...
* concurrency file order TDE-1213 ([#998](https://github.com/paulfouquet/topo-imagery-test/issues/998)) ([37dcb8b](https://github.com/paulfouquet/topo-imagery-test/commit/37dcb8b49d9a0cf45dcc6d0ce3011a4d6016e9e7))
...
* create a new release please PR to fix bug ([#548](https://github.com/paulfouquet/topo-imagery-test/issues/548)) ([c809721](https://github.com/paulfouquet/topo-imagery-test/commit/c8097217c318a04875d5918ce474552a4e4a3e93))
* Disable duplicate code test ([#817](https://github.com/paulfouquet/topo-imagery-test/issues/817)) ([cde875d](https://github.com/paulfouquet/topo-imagery-test/commit/cde875dc730011165b73848338a700394eccdb4b))
...
* error on collection with no items TDE-1216 ([#1000](https://github.com/paulfouquet/topo-imagery-test/issues/1000)) ([d351d85](https://github.com/paulfouquet/topo-imagery-test/commit/d351d85f42fd096628b65629f8be30a5f617d920))
* footprint should exists if tiff already exists ([#890](https://github.com/paulfouquet/topo-imagery-test/issues/890)) ([9868072](https://github.com/paulfouquet/topo-imagery-test/commit/9868072acbcf95ef58e1ad9b209f7b4a4a647011))
...
* fs_local.write() fails when directory does not exist ([#445](https://github.com/paulfouquet/topo-imagery-test/issues/445)) ([935a041](https://github.com/paulfouquet/topo-imagery-test/commit/935a0419ee7c550793088c279e060d315bf8dad9))
* fs_s3.read() exceptions are not caught properly ([#432](https://github.com/paulfouquet/topo-imagery-test/issues/432)) ([3a855d5](https://github.com/paulfouquet/topo-imagery-test/commit/3a855d55f9a59bfe2d081835663b18b574380faa))
...
* gdal info reference wrong file ([#347](https://github.com/paulfouquet/topo-imagery-test/issues/347)) ([52a2ee7](https://github.com/paulfouquet/topo-imagery-test/commit/52a2ee7354e939ed93b44f3b3d1d537e1d337d92))
* gdal should not create bigtiff TDE-805 ([#632](https://github.com/paulfouquet/topo-imagery-test/issues/632)) ([b33825f](https://github.com/paulfouquet/topo-imagery-test/commit/b33825fdaecebe64500bac74c96adf3e07a1f302))
* gdal should try reading file before getting credentials TDE-929 ([#852](https://github.com/paulfouquet/topo-imagery-test/issues/852)) ([83c9a68](https://github.com/paulfouquet/topo-imagery-test/commit/83c9a680868649bf458636d2727889a3eaf27c41))
* gdalbuildvrt fails when coordinate system description is different TDE-818 ([#596](https://github.com/paulfouquet/topo-imagery-test/issues/596)) ([5758400](https://github.com/paulfouquet/topo-imagery-test/commit/575840018ced624ba8e4b179c7068b59461f975b))
...
* handle 50k imagery filenames TDE-1014 ([#845](https://github.com/paulfouquet/topo-imagery-test/issues/845)) ([07a7af5](https://github.com/paulfouquet/topo-imagery-test/commit/07a7af50c915a39e0108e87b66eb8837fd8a6e77))
* handle already existing collection JSON ([#532](https://github.com/paulfouquet/topo-imagery-test/issues/532)) ([7a26bae](https://github.com/paulfouquet/topo-imagery-test/commit/7a26bae03d8b2d9090cfb8dfb24d42473a0b2b62))
* handle percent-encoded urls TDE-1054 ([#881](https://github.com/paulfouquet/topo-imagery-test/issues/881)) ([eacc453](https://github.com/paulfouquet/topo-imagery-test/commit/eacc4532407129cae02dfb209ac9293a3294584e))
...
* log wrong vsis3 path non visual qa TDE-563 ([#343](https://github.com/paulfouquet/topo-imagery-test/issues/343)) ([388ae19](https://github.com/paulfouquet/topo-imagery-test/commit/388ae1936782c6bf71b980efce9a739f2671c519))
* Make build compatible with new GDAL container TDE-1179 ([#971](https://github.com/paulfouquet/topo-imagery-test/issues/971)) ([719d96e](https://github.com/paulfouquet/topo-imagery-test/commit/719d96e1ff1133c351bbee7a1d93fa359cc702e4))
* Make build compatible with new GDAL container TDE-1179 ([#977](https://github.com/paulfouquet/topo-imagery-test/issues/977)) ([f377d61](https://github.com/paulfouquet/topo-imagery-test/commit/f377d61f6c9471d9458b01db19aa62d2c4abd278))
* Make compatible with latest moto ([#949](https://github.com/paulfouquet/topo-imagery-test/issues/949)) ([5902df0](https://github.com/paulfouquet/topo-imagery-test/commit/5902df0fec6dd15bb3a89ec616a2c27136a6aec5))
...
* minor changes to be consistent with current data ([#790](https://github.com/paulfouquet/topo-imagery-test/issues/790)) ([4892b6b](https://github.com/paulfouquet/topo-imagery-test/commit/4892b6b30dfc5cb7cc3a00a5eef52b6fde8447ee))
...
* non visual qa errors logged twice TDE-563 ([#320](https://github.com/paulfouquet/topo-imagery-test/issues/320)) ([41c4c98](https://github.com/paulfouquet/topo-imagery-test/commit/41c4c98aa5ef0cfbf4bf28632bb07c1b5d398e9d))
* non-visual QA greyscale TDE-832 ([#593](https://github.com/paulfouquet/topo-imagery-test/issues/593)) ([afe25f3](https://github.com/paulfouquet/topo-imagery-test/commit/afe25f38c61ea671fa1942c1a1cdab9be3dba6f0))
* NoSuchFileError is stopping multiprocessing sidecar files TDE-1007 ([#832](https://github.com/paulfouquet/topo-imagery-test/issues/832)) ([dea3189](https://github.com/paulfouquet/topo-imagery-test/commit/dea3189b9afbb198e02888ed6ef9ebb17687a000))
...
* re-standardising TileByteCounts error TDE-850 ([#644](https://github.com/paulfouquet/topo-imagery-test/issues/644)) ([c762202](https://github.com/paulfouquet/topo-imagery-test/commit/c762202d49b09e1b8c538b0aa3fd7c6fed485e3c))
* recreate webp overviews TDE-869 ([#650](https://github.com/paulfouquet/topo-imagery-test/issues/650)) ([c1f265a](https://github.com/paulfouquet/topo-imagery-test/commit/c1f265a451ed495874bc7cc70c5cca7182a896ad))
* release-please.yml fails prettier ([#307](https://github.com/paulfouquet/topo-imagery-test/issues/307)) ([330fa04](https://github.com/paulfouquet/topo-imagery-test/commit/330fa04c609f4996bac1c77701aaca5305ed1f45))
* remove no data value (255) ensure is not none ([#360](https://github.com/paulfouquet/topo-imagery-test/issues/360)) ([a1154e8](https://github.com/paulfouquet/topo-imagery-test/commit/a1154e892053a6f15ef6b5c030d69ca261d95e39))
...
* should use unique file names when copying files to standardise TDE-1186 ([#974](https://github.com/paulfouquet/topo-imagery-test/issues/974)) ([8b783dc](https://github.com/paulfouquet/topo-imagery-test/commit/8b783dce9870ff2bb5331552ff730218419f247c))
* sidecars download permissions TDE-1007 ([#806](https://github.com/paulfouquet/topo-imagery-test/issues/806)) ([16b5b04](https://github.com/paulfouquet/topo-imagery-test/commit/16b5b0472d10f0ec9f0a3a6689af9e1edfcb7fda))
...
* standardised path is not logged when non_visual_qa_passed ([#591](https://github.com/paulfouquet/topo-imagery-test/issues/591)) ([0c19104](https://github.com/paulfouquet/topo-imagery-test/commit/0c1910493a2952f21abe19d7d8df5ae5d43bcccf))
* standardising_validate.py fails when scale is 'None' ([#480](https://github.com/paulfouquet/topo-imagery-test/issues/480)) ([17296f1](https://github.com/paulfouquet/topo-imagery-test/commit/17296f1e0ffbb46d5160814ca6096d4c5893c996))
* stats are not written when retiling TDE-829 ([#599](https://github.com/paulfouquet/topo-imagery-test/issues/599)) ([c4bf5f2](https://github.com/paulfouquet/topo-imagery-test/commit/c4bf5f2fc78e66177b459b1e9482bc830b45a59a))
* storing count is not used TDE-842 ([#633](https://github.com/paulfouquet/topo-imagery-test/issues/633)) ([8cfc405](https://github.com/paulfouquet/topo-imagery-test/commit/8cfc405a712d54273f90ec223cc7c7ffc22bce68))
...
* trailing char in local path is removed ([#389](https://github.com/paulfouquet/topo-imagery-test/issues/389)) ([604e591](https://github.com/paulfouquet/topo-imagery-test/commit/604e5911a7821d299cd6a2b5dc92176e4559a5eb))
* Treat "no data" value as a decimal number TDE-1077 ([#893](https://github.com/paulfouquet/topo-imagery-test/issues/893)) ([a9b4a84](https://github.com/paulfouquet/topo-imagery-test/commit/a9b4a84cbfa84ea48dd3e970c9fabe6175058001))
* Treat item as `dict` TDE-1209 ([#993](https://github.com/paulfouquet/topo-imagery-test/issues/993)) ([384d0fc](https://github.com/paulfouquet/topo-imagery-test/commit/384d0fc674ce8fe4f1ff8726362881887a68522f))
* typo in prod ([#788](https://github.com/paulfouquet/topo-imagery-test/issues/788)) ([275a665](https://github.com/paulfouquet/topo-imagery-test/commit/275a6658f2144f2a4cf2a690a2ea2b701aafc44b))
* typo in readme ([#682](https://github.com/paulfouquet/topo-imagery-test/issues/682)) ([544d271](https://github.com/paulfouquet/topo-imagery-test/commit/544d271cf48120574ac43edc40d5ef91e34b49c7))
* unescaped bracket ([#426](https://github.com/paulfouquet/topo-imagery-test/issues/426)) ([f579638](https://github.com/paulfouquet/topo-imagery-test/commit/f57963854d0d3f61585055d2fbc5e3174f7948ea))
* update gdal version to 3.8.4 to fix footprints bug TDE-1106 ([#923](https://github.com/paulfouquet/topo-imagery-test/issues/923)) ([7a3367e](https://github.com/paulfouquet/topo-imagery-test/commit/7a3367ed9edebae49ebc50044ebe03a9e6fe63a6))
* update permissions ([#415](https://github.com/paulfouquet/topo-imagery-test/issues/415)) ([71c3fe9](https://github.com/paulfouquet/topo-imagery-test/commit/71c3fe9434209c2f87c333fe2323569a9d24d6a9))
* update wording for release ([#878](https://github.com/paulfouquet/topo-imagery-test/issues/878)) ([dcc7972](https://github.com/paulfouquet/topo-imagery-test/commit/dcc7972195e685b5865c20b0bb15acac9ed51319))
* upgrade gdal to 3.7.2 for webp fix ([#677](https://github.com/paulfouquet/topo-imagery-test/issues/677)) ([bdb4802](https://github.com/paulfouquet/topo-imagery-test/commit/bdb48021c7e3b66d85840a23c688b4737298e949))
...
* Use correct types for S3 client ([#954](https://github.com/paulfouquet/topo-imagery-test/issues/954)) ([2c96c13](https://github.com/paulfouquet/topo-imagery-test/commit/2c96c1382d521d641e2b167e4096759af9b13dce))
* Use integer coordinates TDE-1077 ([#895](https://github.com/paulfouquet/topo-imagery-test/issues/895)) ([b381bb6](https://github.com/paulfouquet/topo-imagery-test/commit/b381bb690d7bef68d15194b147568bcd1b8561f1))
* use multithreading for gdalwarp when creating COGS TDE-696 ([#399](https://github.com/paulfouquet/topo-imagery-test/issues/399)) ([061d3d6](https://github.com/paulfouquet/topo-imagery-test/commit/061d3d67bdb7a7385ffd84b0d060edde0010bd8c))
* write_file was not handling exception correctly TDE-1007 ([#836](https://github.com/paulfouquet/topo-imagery-test/issues/836)) ([caa289b](https://github.com/paulfouquet/topo-imagery-test/commit/caa289b240989f860f66412c0d028752ec1a17d9))
* wrong vsis3 path logged ([#906](https://github.com/paulfouquet/topo-imagery-test/issues/906)) ([f491eb1](https://github.com/paulfouquet/topo-imagery-test/commit/f491eb1578ef3462170b79edb5f7775596ca2481))


### Reverts

* "chore: upgrade gdal from 3.6.1 to 3.7.0 ([#479](https://github.com/paulfouquet/topo-imagery-test/issues/479))" ([#536](https://github.com/paulfouquet/topo-imagery-test/issues/536)) ([810b73c](https://github.com/paulfouquet/topo-imagery-test/commit/810b73c566e482b3caf29a73c1ffaccc32a6a1b4))
* "fix: Make build compatible with new GDAL container TDE-1179 ([#971](https://github.com/paulfouquet/topo-imagery-test/issues/971))" ([#975](https://github.com/paulfouquet/topo-imagery-test/issues/975)) ([3990bf9](https://github.com/paulfouquet/topo-imagery-test/commit/3990bf967e4da461b3e1de7d079aa3f14ed0046c))
* "revert: "chore: upgrade gdal from 3.6.1 to 3.7.0 ([#479](https://github.com/paulfouquet/topo-imagery-test/issues/479))" ([#536](https://github.com/paulfouquet/topo-imagery-test/issues/536))" ([#544](https://github.com/paulfouquet/topo-imagery-test/issues/544)) ([ca824f9](https://github.com/paulfouquet/topo-imagery-test/commit/ca824f91b57f4f245c9813928d4845f63fd9c1c6))
* Pull Requests [#993](https://github.com/paulfouquet/topo-imagery-test/issues/993) and [#985](https://github.com/paulfouquet/topo-imagery-test/issues/985) ([#997](https://github.com/paulfouquet/topo-imagery-test/issues/997)) ([289880c](https://github.com/paulfouquet/topo-imagery-test/commit/289880c6886a2bbe6908feb2924aa68f1a7750a8))


### Documentation

* add explaination about collection provider tests ([#764](https://github.com/paulfouquet/topo-imagery-test/issues/764)) ([4e84901](https://github.com/paulfouquet/topo-imagery-test/commit/4e84901abe30ca0294ae570caef7fba511fe0ce5))
* add missing docstring ([#487](https://github.com/paulfouquet/topo-imagery-test/issues/487)) ([dd27c7c](https://github.com/paulfouquet/topo-imagery-test/commit/dd27c7c3f7209e58416e5e517498b0b68e7b3ca5))
* add versioning release section in readme ([#334](https://github.com/paulfouquet/topo-imagery-test/issues/334)) ([7ad502c](https://github.com/paulfouquet/topo-imagery-test/commit/7ad502c11c0ef8130beef3719fb0fb87852a16d8))
* clarify readme ([#854](https://github.com/paulfouquet/topo-imagery-test/issues/854)) ([f0f742d](https://github.com/paulfouquet/topo-imagery-test/commit/f0f742dedcdbaf91f7fa3eb696ccc319b48a3bbe))
* comment to explain why extent is specified ([#584](https://github.com/paulfouquet/topo-imagery-test/issues/584)) ([1971bc2](https://github.com/paulfouquet/topo-imagery-test/commit/1971bc2a5d1cd85c7f26b6b424b01249686888b4))
* Document default "no data" value TDE-1077 ([#901](https://github.com/paulfouquet/topo-imagery-test/issues/901)) ([d15919f](https://github.com/paulfouquet/topo-imagery-test/commit/d15919ffc81309d0767ae13e5e7ab00b37136235))
* improve documentation about release process ([#362](https://github.com/paulfouquet/topo-imagery-test/issues/362)) ([d85653e](https://github.com/paulfouquet/topo-imagery-test/commit/d85653eec0ab254db15a86b1d3aad72a41e13083))
* update docstring for tile_index.py ([#473](https://github.com/paulfouquet/topo-imagery-test/issues/473)) ([38ef275](https://github.com/paulfouquet/topo-imagery-test/commit/38ef275c304164c990675837cbba83076f80e512))
* update README release please instructions ([#496](https://github.com/paulfouquet/topo-imagery-test/issues/496)) ([d7369e0](https://github.com/paulfouquet/topo-imagery-test/commit/d7369e096b7d782e8f97bca10b6b384b70f33f89))
* update README.md ([#481](https://github.com/paulfouquet/topo-imagery-test/issues/481)) ([79add3c](https://github.com/paulfouquet/topo-imagery-test/commit/79add3cd3cd3fb8f5d75ba7a8ca2029145fd0b5a))
